								...
								foreach($admin as $p){ 
									...
									<tr>
										...
										<td>
											...
											<?php if($p->admin_id != 1){ ?>
												<a onclick="return confirm('Yakin ingin hapus?')" href="<?php echo base_url().'dashboard/admin_hapus/'.$p->admin_id; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> </a>
											<?php } ?>
										</td>
									</tr>
								<?php } ?>
