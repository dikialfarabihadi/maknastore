...
<head>
  ...
  <title>TOKO ONLINE KOPI COFFEE SEDAP</title>
          ...
          <ul class="header-btns">
              ...
              <div class="custom-menu" style="left: 100px;">
                <div id="shopping-cart">
                  ...
                  <div class="shopping-cart-btns">
                    <a class="main-btn" href="<?php echo base_url('welcome/keranjang') ?>">Keranjang</a>
                    <a class="primary-btn" href="<?php echo base_url('welcome/checkout') ?>">Checkout <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
              </div>
            </li>
            ...
            if(isset($_SESSION['customer_status'])){
              ...
              <li class="header-account dropdown default-dropdown">
                ...
                <a href="<?php echo base_url('welcome/masuk_vendor') ?>" class="text-uppercase main-btn">Login Vendor</a> 
                <a href="<?php echo base_url('welcome/daftar_vendor') ?>" class="text-uppercase primary-btn">Daftar Vendor</a> 
              </li>
              <?php
            }
            ?>
