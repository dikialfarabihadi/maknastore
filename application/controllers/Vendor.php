...
class Vendor extends CI_Controller {
	...
	function __construct()
	{
		...
		if($this->session->userdata('vendor_status')!="login"){
			redirect(base_url().'masuk_vendor?alert=belum_login');
		}
	}
	...
	public function index()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_index',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	{
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_ganti_password');
		$this->load->view('vendor/v_footer');
	}
	...
	public function ganti_password_aksi()
	{
		...
		if($this->form_validation->run() != false){
			...
			$where = array(
				...
				'vendor_password' => md5($password_lama)
			);
			$cek = $this->m_data->cek_login('vendor', $where)->num_rows();

			// cek kesesuaikan password lama
			if($cek > 0){

				// update data password vendor
				$w = array(
					'vendor_id' => $this->session->userdata('id')
				);
				$data = array(
					'vendor_password' => md5($password_baru)
				);
				$this->m_data->update_data($where, $data, 'vendor');

				// alihkan halaman kembali ke halaman ganti password
				redirect('vendor/ganti_password?alert=sukses');
			}else{
				// alihkan halaman kembali ke halaman ganti password
				redirect('vendor/ganti_password?alert=gagal');
			}
	...
	{
		$data['kategori'] = $this->m_data->edit_data(array('kategori_parent' => '0'), 'kategori')->result();
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_kategori',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function kategori_tambah()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_kategori_tambah',$data);
		$this->load->view('vendor/v_footer');
	}

	public function kategori_aksi()
	{
		$this->form_validation->set_rules('nama','Nama kategori','required|is_unique[kategori.kategori_nama]');
		...
		if($this->form_validation->run() != false){
			...
			redirect(base_url().'vendor/kategori');
			
		}else{
			$this->load->view('vendor/v_header');
			$this->load->view('vendor/v_kategori_tambah');
			$this->load->view('vendor/v_footer');
		}
	}
	...
	public function kategori_edit($id)
	{
		...
		$data['e'] = $this->m_data->edit_data($where,'kategori')->row();
		$data['kategori'] = $this->db->query("select * from kategori where kategori_id!='$id'")->result();
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_kategori_edit',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function kategori_update()
	{
		...
		$lama = $this->m_data->edit_data($where,'kategori')->row();

		if($this->input->post('nama') != $lama->kategori_nama) {
			$is_unique =  '|is_unique[kategori.kategori_nama]';
		} else {
			$is_unique =  '';
		}
		
		$this->form_validation->set_rules('nama','Nama kategori','required'.$is_unique);
		$this->form_validation->set_rules('icon','Icon','required');
	...
	public function customer()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_customer',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	{
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_customer_tambah');
		$this->load->view('vendor/v_footer');
	}
	...
	public function customer_aksi()
	{
		...
		if($this->form_validation->run() != false){
			...
			redirect(base_url().'vendor/customer');
	...
	public function customer_edit($id)
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_customer_edit',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function produk()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_produk',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function produk_tambah()
	{
		$data['kategori'] = $this->m_data->get_data('kategori')->result();
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_produk_tambah',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function produk_aksi()
	{
		...
		if($this->form_validation->run() != false){
			...
			redirect(base_url().'vendor/produk');	
	...
	public function produk_edit($id)
	{
		...
		$data['kategori'] = $this->m_data->get_data('kategori')->result();
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_produk_edit',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function transaksi()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_transaksi',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function transaksi_invoice($id_invoice)
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_transaksi_invoice',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function transaksi_invoice_cetak($id_invoice)
	{
		...
		$this->load->view('vendor/v_transaksi_invoice_cetak',$data);
	}
	...
	public function transaksi_status()
	{
		...
		redirect(base_url().'vendor/transaksi');
	}
	...
	public function laporan()
	{
		...
		if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari'])){
			...
			$this->load->view('vendor/v_header');
			$this->load->view('vendor/v_laporan',$data);
			$this->load->view('vendor/v_footer');
		}else{
			$this->load->view('vendor/v_header');
			$this->load->view('vendor/v_laporan');
			$this->load->view('vendor/v_footer');
		}
	...
	public function laporan_print()
	{
		...
		if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari'])){
			...
			$tgl_sampai = $_GET['tanggal_sampai'];
			$data['data'] = $this->db->query("SELECT * FROM invoice,customer WHERE invoice_customer=customer_id and date(invoice_tanggal) >= '$tgl_dari' AND date(invoice_tanggal) <= '$tgl_sampai'")->result();
			$this->load->view('vendor/v_laporan_print',$data);
		}else{
			$this->load->view('vendor/v_laporan_print');
		}
	...
	public function laporan_pdf()
	{
		...
		if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari'])){
			...
			$data['data'] = $this->db->query("SELECT * FROM invoice,customer WHERE invoice_customer=customer_id and date(invoice_tanggal) >= '$tgl_dari' AND date(invoice_tanggal) <= '$tgl_sampai'")->result();
			$html = $this->load->view('vendor/v_laporan_pdf',$data, true);	
	...
	public function admin()
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_admin',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	{
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_admin_tambah');
		$this->load->view('vendor/v_footer');
	}
	...
	public function admin_aksi()
	{
		...
		$this->form_validation->set_rules('email','Email admin','required|is_unique[admin.admin_email]|valid_email');
		...
		if($this->form_validation->run() != false){
			...
			redirect(base_url().'vendor/admin');	
	...
	public function admin_edit($id)
	{
		...
		$this->load->view('vendor/v_header');
		$this->load->view('vendor/v_admin_edit',$data);
		$this->load->view('vendor/v_footer');
	}
	...
	public function admin_update()
	{
		...
		$lama = $this->m_data->edit_data($where,'admin')->row();

		if($this->input->post('email') != $lama->admin_email) {
			$is_unique =  '|is_unique[admin.admin_email]';
		} else {
			$is_unique =  '';
		}
		...
		// Wajib isi
		$this->form_validation->set_rules('nama','Nama admin','required');
		$this->form_validation->set_rules('email','Email admin','required|valid_email'.$is_unique);
